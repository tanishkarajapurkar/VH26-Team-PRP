...
### 4. 🛒 ApexMart-Storefront/
The complete production-ready e-commerce application codebase:
- **ackend/**: Fastify REST API, Supabase / PostgreSQL database integration, and product endpoints.
- **rontend/**: Modern React + Tailwind CSS storefront UI with shopping cart, reviews, and search.
- **Traffic Simulator scripts**:
  - un-traffic-simulator.bat: Continuous virtual traffic simulation that runs when the system is idle.
  - un-surge-simulator.bat: High-concurrency flash-sale traffic surge generator.
...
1. Open a terminal in the ApexMart-Storefront directory.
